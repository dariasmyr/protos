...
type SessionsClient interface {
	GetActiveSessions(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetActiveAccountSessionsResponse, error)
	RefreshSession(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*RefreshAccountSessionResponse, error)
	ValidateSession(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ValidateAccountSessionResponse, error)
...
func (c *sessionsClient) GetActiveSessions(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetActiveAccountSessionsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *sessionsClient) RefreshSession(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*RefreshAccountSessionResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *sessionsClient) ValidateSession(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ValidateAccountSessionResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type SessionsServer interface {
	GetActiveSessions(context.Context, *emptypb.Empty) (*GetActiveAccountSessionsResponse, error)
	RefreshSession(context.Context, *emptypb.Empty) (*RefreshAccountSessionResponse, error)
	ValidateSession(context.Context, *emptypb.Empty) (*ValidateAccountSessionResponse, error)
...
func (UnimplementedSessionsServer) GetActiveSessions(context.Context, *emptypb.Empty) (*GetActiveAccountSessionsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetActiveSessions not implemented")
}
func (UnimplementedSessionsServer) RefreshSession(context.Context, *emptypb.Empty) (*RefreshAccountSessionResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RefreshSession not implemented")
}
func (UnimplementedSessionsServer) ValidateSession(context.Context, *emptypb.Empty) (*ValidateAccountSessionResponse, error) {
...
func _Sessions_GetActiveSessions_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SessionsServer).GetActiveSessions(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Sessions_RefreshSession_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SessionsServer).RefreshSession(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Sessions_ValidateSession_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SessionsServer).ValidateSession(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
